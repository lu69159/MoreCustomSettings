...
public class CustomCampaignRulesDialog extends CampaignRulesDialog{
    ...
    public CustomCampaignRulesDialog(){
        ...
        Events.on(SaveLoadEvent.class, e -> {
            if(state.isCampaign() && !net.client() && Core.settings.getBool("enablecustomcampaigndifficulty")){
    ...
    void rebuild(){
        ...
        cont.top().pane(inner -> {
            ...
            check("@rules.hidespawns", b -> customRule.hideSpawns = b, () -> customRule.hideSpawns);
